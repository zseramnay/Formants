...
\author{%
  ...
  Professeur de nouvelles technologies appliquées à la composition\\
...
(Orchidea) et Yan\_Adds. En introduisant la mesure du \emph{Formant
...
(basson--violon, cor--alto). Neuf principes d'orchestration acoustique
...
\begin{itemize}
  \item \textbf{SOL2020 (Orchidea/EIC)} --- 12~instruments solistes,
...
Les sourdines sont traitées séparément.
...
le pic maximum et distance minimale de \SI{70}{Hz} entre pics. Le
pipeline~v22 a été validé à $\Delta = \SI{0}{Hz}$ pour les 16
instruments SOL2020.
