...
Usage : lancer depuis la racine du repo Formants/
    python3 Scripts/v6-html-docx/build_document_complet.py
"""
import os
import sys
import unicodedata
...
def get_section_body(script_name, tmp_dir):
    ...
    """
    script_path = os.path.join(BASE, 'Scripts', 'v6-html-docx', script_name)
    out_file_map = {
        'build_intro_html_docx.py':    'section_intro_v6.html',
        'build_bois_html_docx.py':     'section_bois_v6.html',
        'build_cuivres_html_docx.py':  'section_cuivres_v6.html',
        'build_sax_html_docx.py':      'section_sax_v6.html',
...
img[src*="specenv_"] { max-width: 51%; }
img[src*="carte_"] { max-width: 51%; }
...
def build_docx_complet():
    ...
    section_scripts = [
        ('build_intro_html_docx.py',    'section_intro_v6.docx'),
        ('build_bois_html_docx.py',     'section_bois_v6.docx'),
        ('build_cuivres_html_docx.py',  'section_cuivres_v6.docx'),
        ('build_sax_html_docx.py',      'section_sax_v6.docx'),
    ...
    r3 = p3.add_run(
        ...
        "SOL2020 Orchidea · Yan_Adds · Backus (1969) · Giesler (1985) · Meyer (2009)\n"
